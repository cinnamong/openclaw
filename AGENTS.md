...
- Telegram-visible proof: use `$telegram-e2e-userbot`; team and CI workers lease Test Server credentials from Convex, while owner-only local maintenance may use explicit BWS slots.
